                ...
                <div className="w-[20rem] bg-white border border-gray-200 rounded-lg shadow ">
                    <div className="p-5 shadow-lg">
                        <div className='mb-1'>
                            ...
                            <input name="title" type="text" value={subject} className='bg-[#D9D9D9] selection:focus:ring-4 font-medium rounded-lg text-sm px-3 py-1.5 inline-flex w-full' onChange={(e) => setSubject(e.target.value)}></input>
                        </div>
                        <div className='mb-1'>
                            <p className="font-normal text-gray-700 pl-[10px]">Location*</p>
                            <select name='location' class="bg-[#D9D9D9] selection:focus:ring-4 font-medium rounded-lg text-sm px-3 py-1.5 text-center inline-flex items-center w-full" value={location} onChange={(e) => {setLocation(e.target.value); console.log(e.target.value)}}>  
                        ...
                        <div className='mb-1'>
                            ...
                            <textarea name='description' type="text" value={description} onChange={(e) => setDescription(e.target.value)} className='bg-[#D9D9D9] h-[129px] resize-none p-[10px] text-[#333] rounded w-full'></textarea>
                        </div>
                        <div className='mb-1'>
                        ...
                        <div className='flex justify-center items-center mt-7'>
                            <button name='submit' disabled={buttonDisabled} type='submit' onClick={handleSubmit} className="flex justify-center items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#043C6C] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 w-[100%] h-[40px]">
                                Submit
